...
# the new dag: add the line from social_help to depression
...
# levels of nodes that directly pointed to cogscore
...
p17 = ggplot(mapping = aes(x = rep(seq(1:length(levels(easyshare_sub_narm$age))),3),
                     y=matrix(t(bn.bayes$cogscore$prob[,,1,1,3]), ncol =1), color = rep(levels(easyshare_sub_narm$cogscore), each = length(levels(easyshare_sub_narm$age))))) + 
  geom_point() +
  geom_line() +
  scale_x_discrete(breaks=seq(1:length(levels(easyshare_sub_narm$age))),
        labels=levels(easyshare_sub_narm$age)) +
...
p18 = ggplot(mapping = aes(x = rep(seq(1:length(levels(easyshare_sub_narm$age))),3),
                     y=matrix(t(bn.bayes$cogscore$prob[,,2,1,3]), ncol =1), color = rep(levels(easyshare_sub_narm$cogscore), each = length(levels(easyshare_sub_narm$age))))) + 
  geom_point() +
  geom_line() +
  scale_x_discrete(breaks=seq(1:length(levels(easyshare_sub_narm$age))),
        labels=levels(easyshare_sub_narm$age)) +
...
p19 = ggplot(mapping = aes(x = rep(seq(1:length(levels(easyshare_sub_narm$age))),3),
                     y=matrix(t(bn.bayes$cogscore$prob[,,1,2,3]), ncol =1), color = rep(levels(easyshare_sub_narm$cogscore), each = length(levels(easyshare_sub_narm$age))))) + 
  geom_point() +
  geom_line() +
  scale_x_discrete(breaks=seq(1:length(levels(easyshare_sub_narm$age))),
        labels=levels(easyshare_sub_narm$age)) +
...
p20 = ggplot(mapping = aes(x = rep(seq(1:length(levels(easyshare_sub_narm$age))),3),
                     y=matrix(t(bn.bayes$cogscore$prob[,,2,2,3]), ncol =1), color = rep(levels(easyshare_sub_narm$cogscore), each = length(levels(easyshare_sub_narm$age))))) + 
  geom_point() +
  geom_line() +
  scale_x_discrete(breaks=seq(1:length(levels(easyshare_sub_narm$age))),
        labels=levels(easyshare_sub_narm$age)) +
...
p21 = ggplot(mapping = aes(x = rep(seq(1:length(levels(easyshare_sub_narm$age))),3),
                     y=matrix(t(bn.bayes$cogscore$prob[,,1,3,3]), ncol =1), color = rep(levels(easyshare_sub_narm$cogscore), each = length(levels(easyshare_sub_narm$age))))) + 
  geom_point() +
  geom_line() +
  scale_x_discrete(breaks=seq(1:length(levels(easyshare_sub_narm$age))),
        labels=levels(easyshare_sub_narm$age)) +
...
p22 = ggplot(mapping = aes(x = rep(seq(1:length(levels(easyshare_sub_narm$age))),3),
                     y=matrix(t(bn.bayes$cogscore$prob[,,2,3,3]), ncol =1), color = rep(levels(easyshare_sub_narm$cogscore), each = length(levels(easyshare_sub_narm$age))))) + 
  geom_point() +
  geom_line() +
  scale_x_discrete(breaks=seq(1:length(levels(easyshare_sub_narm$age))),
        labels=levels(easyshare_sub_narm$age)) +
...
p23 = ggplot(mapping = aes(x = rep(seq(1:length(levels(easyshare_sub_narm$age))),3),
                     y=matrix(t(bn.bayes$cogscore$prob[,,1,4,3]), ncol =1), color = rep(levels(easyshare_sub_narm$cogscore), each = length(levels(easyshare_sub_narm$age))))) + 
  geom_point() +
  geom_line() +
  scale_x_discrete(breaks=seq(1:length(levels(easyshare_sub_narm$age))),
        labels=levels(easyshare_sub_narm$age)) +
...
p24 = ggplot(mapping = aes(x = rep(seq(1:length(levels(easyshare_sub_narm$age))),3),
                     y=matrix(t(bn.bayes$cogscore$prob[,,2,4,3]), ncol =1), color = rep(levels(easyshare_sub_narm$cogscore), each = length(levels(easyshare_sub_narm$age))))) + 
  geom_point() +
  geom_line() +
  scale_x_discrete(breaks=seq(1:length(levels(easyshare_sub_narm$age))),
        labels=levels(easyshare_sub_narm$age)) +
...
# 
# grid.arrange(p1,p2,p5,p6,p9,p10,p13,p14,p17,p18,p21,p22, nrow = 3)
...
table1 = matrix(t(cbind(bn.bayes$cogscore$prob[,,1,2,1][,1],
                      bn.bayes$cogscore$prob[,,1,2,2][,1],
                      bn.bayes$cogscore$prob[,,1,2,3][,1])),ncol=1)
...
pp1 = ggplot(mapping = aes(x = rep(seq(1:length(levels(easyshare_sub_narm$depression))),3),
  ...
  labs(x = "Depression", y= "Conditional probability", color = "Cognitive score", title ="[0,55), M, Basic education")


table2 = matrix(t(cbind(bn.bayes$cogscore$prob[,,1,2,1][,3],
                      bn.bayes$cogscore$prob[,,1,2,2][,3],
                      bn.bayes$cogscore$prob[,,1,2,3][,3])),ncol=1)
...
pp2 = ggplot(mapping = aes(x = rep(seq(1:length(levels(easyshare_sub_narm$depression))),3),
  ...
  scale_x_discrete(breaks=seq(1:length(levels(easyshare_sub_narm$depression))),
        labels=levels(easyshare_sub_narm$depression)) +
  labs(x = "Depression", y= "Conditional probability", color = "Cognitive score", title ="[60,65), M, Basic education")


table3 = matrix(t(cbind(bn.bayes$cogscore$prob[,,1,2,1][,5],
                      bn.bayes$cogscore$prob[,,1,2,2][,5],
                      bn.bayes$cogscore$prob[,,1,2,3][,5])),ncol=1)
...
pp3 = ggplot(mapping = aes(x = rep(seq(1:length(levels(easyshare_sub_narm$depression))),3),
  ...
  scale_x_discrete(breaks=seq(1:length(levels(easyshare_sub_narm$depression))),
        labels=levels(easyshare_sub_narm$depression)) +
  labs(x = "Depression", y= "Conditional probability", color = "Cognitive score", title ="[70,75), M, Basic education")


table4 = matrix(t(cbind(bn.bayes$cogscore$prob[,,1,2,1][,7],
                      bn.bayes$cogscore$prob[,,1,2,2][,7],
                      bn.bayes$cogscore$prob[,,1,2,3][,7])),ncol=1)
...
pp4 = ggplot(mapping = aes(x = rep(seq(1:length(levels(easyshare_sub_narm$depression))),3),
  ...
  scale_x_discrete(breaks=seq(1:length(levels(easyshare_sub_narm$depression))),
        labels=levels(easyshare_sub_narm$depression)) +
  labs(x = "Depression", y= "Conditional probability", color = "Cognitive score", title =">80, M, Basic education")


table5 = matrix(t(cbind(bn.bayes$cogscore$prob[,,2,2,1][,1],
                      bn.bayes$cogscore$prob[,,2,2,2][,1],
                      bn.bayes$cogscore$prob[,,2,2,3][,1])),ncol=1)
...
pp5 = ggplot(mapping = aes(x = rep(seq(1:length(levels(easyshare_sub_narm$depression))),3),
  ...
  scale_x_discrete(breaks=seq(1:length(levels(easyshare_sub_narm$depression))),
        labels=levels(easyshare_sub_narm$depression)) +
  labs(x = "Depression", y= "Conditional probability", color = "Cognitive score", title ="[0,55), F, Basic education")


table6 = matrix(t(cbind(bn.bayes$cogscore$prob[,,2,2,1][,3],
                      bn.bayes$cogscore$prob[,,2,2,2][,3],
                      bn.bayes$cogscore$prob[,,2,2,3][,3])),ncol=1)
...
pp6 = ggplot(mapping = aes(x = rep(seq(1:length(levels(easyshare_sub_narm$depression))),3),
  ...
  scale_x_discrete(breaks=seq(1:length(levels(easyshare_sub_narm$depression))),
        labels=levels(easyshare_sub_narm$depression)) +
  labs(x = "Depression", y= "Conditional probability", color = "Cognitive score", title ="[60,65), F, Basic education")


table7 = matrix(t(cbind(bn.bayes$cogscore$prob[,,2,2,1][,5],
                      bn.bayes$cogscore$prob[,,2,2,2][,5],
                      bn.bayes$cogscore$prob[,,2,2,3][,5])),ncol=1)
...
pp7 = ggplot(mapping = aes(x = rep(seq(1:length(levels(easyshare_sub_narm$depression))),3),
  ...
  scale_x_discrete(breaks=seq(1:length(levels(easyshare_sub_narm$depression))),
        labels=levels(easyshare_sub_narm$depression)) +
  labs(x = "Depression", y= "Conditional probability", color = "Cognitive score", title ="[70,75), F, Basic education")


table8 = matrix(t(cbind(bn.bayes$cogscore$prob[,,2,2,1][,7],
                      bn.bayes$cogscore$prob[,,2,2,2][,7],
                      bn.bayes$cogscore$prob[,,2,2,3][,7])),ncol=1)
...
pp8 = ggplot(mapping = aes(x = rep(seq(1:length(levels(easyshare_sub_narm$depression))),3),
  ...
  scale_x_discrete(breaks=seq(1:length(levels(easyshare_sub_narm$depression))),
        labels=levels(easyshare_sub_narm$depression)) +
  labs(x = "Depression", y= "Conditional probability", color = "Cognitive score", title =">80, F, Basic education")
...
```{r, fig.height=10, fig.width=20}
# education
table1 = matrix(t(cbind(bn.bayes$cogscore$prob[,,1,1,1][,5],
                      bn.bayes$cogscore$prob[,,2,1,1][,5])),ncol=1)
...
pp1 = ggplot(mapping = aes(x = rep(seq(1:length(levels(easyshare_sub_narm$education))),3),
  ...
  scale_x_discrete(breaks=seq(1:length(levels(easyshare_sub_narm$education))),
        labels=levels(easyshare_sub_narm$education)) +
  labs(x = "Education", y= "Conditional probability", color = "Cognitive score", title ="[70,75), None education, Low depression")


table2 = matrix(t(cbind(bn.bayes$cogscore$prob[,,1,2,1][,5],
                      bn.bayes$cogscore$prob[,,2,2,1][,5])),ncol=1)
...
pp2 = ggplot(mapping = aes(x = rep(seq(1:length(levels(easyshare_sub_narm$education))),3),
  ...
  scale_x_discrete(breaks=seq(1:length(levels(easyshare_sub_narm$education))),
        labels=levels(easyshare_sub_narm$education)) +
  labs(x = "Education", y= "Conditional probability", color = "Cognitive score", title ="[70,75), Basic education, Low depression")


table3 = matrix(t(cbind(bn.bayes$cogscore$prob[,,1,3,1][,5],
                      bn.bayes$cogscore$prob[,,2,3,1][,5])),ncol=1)
...
pp3 = ggplot(mapping = aes(x = rep(seq(1:length(levels(easyshare_sub_narm$education))),3),
  ...
  scale_x_discrete(breaks=seq(1:length(levels(easyshare_sub_narm$education))),
        labels=levels(easyshare_sub_narm$education)) +
  labs(x = "Education", y= "Conditional probability", color = "Cognitive score", title ="[70,75), Secondary education, Low depression")


table4 = matrix(t(cbind(bn.bayes$cogscore$prob[,,1,4,1][,5],
                      bn.bayes$cogscore$prob[,,2,4,1][,5])),ncol=1)
...
pp4 = ggplot(mapping = aes(x = rep(seq(1:length(levels(easyshare_sub_narm$education))),3),
  ...
  scale_x_discrete(breaks=seq(1:length(levels(easyshare_sub_narm$education))),
        labels=levels(easyshare_sub_narm$education)) +
  labs(x = "Education", y= "Conditional probability", color = "Cognitive score", title ="[70,75), Tertiary education, Low depression")
