...
temp=subset(easyshare, select=-c(recall_1, recall_2,orienti, numeracy_1,numeracy_2))
for (i in 4:8){
  missmap(temp[temp$wave==i,], col = c("firebrick1", "dodgerblue"), main = paste("Missingness Map wave",i))
}
...
# test: drop the line from education to smoke
dag2=easyshare_sub.iamb
dag2=drop.arc(dag2,  from = "education", to= "smoke")
