...
# education
easyshare_sub$education=easyshare_sub$education %>% fct_collapse("basic" = c("1","2"))
easyshare_sub$education=easyshare_sub$education %>% fct_collapse("secondary" = c("3","4"))
easyshare_sub$education=easyshare_sub$education %>% fct_collapse("tertiary" = c("5","6"))
easyshare_sub$education=easyshare_sub$education %>% fct_collapse("other" = c("0","95","97"))
...
# drinking
levels(easyshare_sub$drinking) <- list("none" = "1", "low" = c("2","3"), "moderate" = c("4","5","6"), "high" = "7")
# depression
